...
class PhrogDataset(Dataset):
    def __init__(
        ...
        max_length,
        dataset_name="phrog",
        d_output=9, # default binary classification
        dest_path=None,
        tokenizer=None,
        tokenizer_name=None,
        use_padding=True,
        ...
        # base_path = Path(dest_path)  / split
        fasta_file = os.path.join(dest_path, f"{split}.faa")
        self.label_to_id = {
                            'DNA, RNA and nucleotide metabolism': 0, 'connector':1, 'head and packaging': 2, 'integration and excision': 3, 
                            'lysis': 4, 'moron, auxiliary metabolic gene and host takeover': 5, 'other': 6, 
                            'transcription regulation': 7, 'tail': 8
                        }
...
if __name__ == "__main__":
    ...
    train_dataset = PhrogDataset(split='train',
        max_length=512,
        dataset_name="phrog",
        d_output=9, # default binary classification
        dest_path="/raid_elmo/home/lr/zym/data/protein_data/fine_tuning/phrog/fold_1",
        tokenizer=tokenizer,
        tokenizer_name="char",
        use_padding=True,
        add_eos=False,
    ...
    dev_dataset = PhrogDataset(split='test',
        max_length=512,
        dataset_name="phrog",
        d_output=9, # default binary classification
        dest_path="/raid_elmo/home/lr/zym/data/protein_data/fine_tuning/phrog/fold_1",
    ...
    # test_dataset = PhrogDataset(split='test',
    #     max_length=1024,
    #     dataset_name="homology",
    #     d_output=3, # default binary classification
