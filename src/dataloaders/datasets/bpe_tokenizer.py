...
class BPETokenizer(PreTrainedTokenizer):
    def __init__(self, vocab_file: str, merges_file: str, model_max_length: int, padding_side: str='left', **kwargs):
        """BPE tokenizer for Hugging Face transformers.
        ...
        with open(vocab_file, 'r') as file:
            char_to_id_mapping = json.load(file)
        self._vocab_str_to_int.update(char_to_id_mapping)
