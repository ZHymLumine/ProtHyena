...
class Phrog(Prot14M):
    ...
    def __init__(self, dest_path=None, tokenizer_name=None, dataset_config_name=None, d_output=9, max_length=1024, rc_aug=False,
                 max_length_val=None, max_length_test=None, cache_dir=None, val_ratio=0.0005, val_split_seed=2357,
                 add_eos=True, detokenize=False, val_only=False, batch_size=32, batch_size_eval=None, num_workers=1,
    ...
    def init_datasets(self):
        ...
        #                 rc_aug=self.rc_aug,
        #     )
        #     for split, max_len in zip(['train', 'test_shuffle'], [self.max_length, self.max_length_val])
        # ]
        return
